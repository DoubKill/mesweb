  ...
  methods: {
    ...
    async getWeighInformation(id, page) {
      try {
        ...
        const data = await weighInformationUrl('get', null, { params: { feed_back_id: id, page: page,
    ...
    async clickView(row, id, index) {
      ...
      try {
        ...
        console.log(this.curveInformationList, 77777)
