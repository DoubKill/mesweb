<template>
  <div v-loading="loading" class="app-container outbound_manage">
    ...
    <el-button v-permission="['inventory_plan','norman']" class="button-right" @click="normalOutbound">正常出库</el-button>
    <el-button v-permission="['inventory_plan','assign']" class="button-right" @click="assignOutbound">指定出库</el-button>
    <el-table
      border
      :data="tableData"
      size="mini"
