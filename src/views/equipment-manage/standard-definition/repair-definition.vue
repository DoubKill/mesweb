        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item
              ...
              prop="equip_fault_name"
            >
              <el-input v-model="typeForm.equip_fault_name" disabled>
...
export default {
  ...
  components: { page, SparePartsCode, ProjectDefinition, FaultClassify, project },
  props: {
    isDialog: {
      type: Boolean,
      default: false
    ...
    templateDownload() {
      ...
      _api(obj)
        .then(res => {
          ...
          link.download = `设备维修标准定义${setDate('', true)}.xlsx` // 下载的文件名
